...
> ## ⚠️ 이 문서는 옛 방식입니다 (2026-08-15 이전)
>
> 구글 Gemini 사용 한도(spend cap)가 걸리면서 말씀지기가 멈췄습니다.
> **지금은 API 키 없이, 교회 컴퓨터의 Claude CLI 가 직접 답을 만듭니다.**
> 설치·점검은 → **[AI-CLI-워커-안내.md](AI-CLI-워커-안내.md)** 를 보세요.
>
> 아래 내용은 Edge Function(`counsel`) 방식의 기록으로 남겨 둡니다.
> 함수는 지우지 않았으므로, 나중에 API 키를 넣으면 다시 쓸 수 있습니다.
